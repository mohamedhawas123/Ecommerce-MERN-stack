...
//    const {name, email} = userDetails.user.userLogin.userInfo 
    ...
    useEffect(() => {
        ...
        setName(userDetails.user.userLogin && userDetails.user.userLogin.userInfo.name)
        setEmail(userDetails.user.userLogin&&userDetails.user.userLogin.userInfo.email)
