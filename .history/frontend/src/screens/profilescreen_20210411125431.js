...
//    const {name, email} = userDetails.user.userLogin.userInfo 
    ...
    const token = userLogin.userLogin.userInfo && userLogin.userLogin.userInfo.token
    ...
    useEffect(() => {
        ...
        setName(userDetails.user.userLogin.userInfo && userDetails.user.userLogin.userInfo.name)
        setEmail(userDetails.user.userLogin.userInfo&&userDetails.user.userLogin.userInfo.email)
    }, [dispatch, history, userInfo])

    const submitHandler = (e) => {
        e.preventDefault()
        dispatch(updateUserProfile(namee, emaill, token ))
        console.log("works")
