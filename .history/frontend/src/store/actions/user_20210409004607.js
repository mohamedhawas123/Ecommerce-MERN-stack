...
export const updateUserProfile = (user) =>  async (dispatch, getState) => {
    ...
    try {
        ...
        const config = {
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYwNGU2MzA2YmQ2YzNiMjkxZWQxMmZhOSIsImlhdCI6MTYxNzkyMTk1NCwiZXhwIjoxNjIwNTEzOTU0fQ.-H2OPMMSUzneBfvSzwTrgBFY9qoHLTL3EDt-jHcUDCg`
            },
        }
